...
# v1.1 (Changed For Windows)

#####################################################################################################
#                                                   #
#  Author: Jinkun Ong @https://twitter.com/sec_9emin1                               #
#  Author(For Windows): Unknown @https://github.com/UnknownU0                                       #
#                                                   #
#                                                       #
...
def main():
    ...
    time.sleep(1)
    try:
        os.system("x86_64-w64-mingw32-g++ -shared -o charlotte.dll charlotte.cpp -fpermissive 2>%temp%\\Unknown_charlotte_Compile")
        print("[*]                    Cross Compile Success!                      [*]")
    except:
        print("[*]                    Compilation failed :(                       [*]")
    time.sleep(1)
    print("[*]                    Removing charlotte.cpp...                   [*]")
    os.system("del charlotte.cpp")
    time.sleep(1)
